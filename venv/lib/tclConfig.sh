...
# installed.
TCL_PREFIX='/home/gurparas/Projects/Spectra/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/gurparas/Projects/Spectra/venv'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/gurparas/Projects/Spectra/venv/include -fdebug-prefix-map=/croot/tk_1755243777296/work=/usr/local/src/conda/tk-8.6.15 -fdebug-prefix-map=/home/gurparas/Projects/Spectra/venv=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/gurparas/Projects/Spectra/venv/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/gurparas/Projects/Spectra/venv/lib -Wl,-rpath-link,/home/gurparas/Projects/Spectra/venv/lib -L/home/gurparas/Projects/Spectra/venv/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/gurparas/Projects/Spectra/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/gurparas/Projects/Spectra/venv/include'
...
TCL_PACKAGE_PATH='/home/gurparas/Projects/Spectra/venv/lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/gurparas/Projects/Spectra/venv/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/croot/tk_1755243777296/work/tcl8.6.15/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/gurparas/Projects/Spectra/venv/lib/libtclstub8.6.a'
